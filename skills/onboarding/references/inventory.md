...
For missing or outdated chain profiles, RPC references, or SFDP identity-pair configuration, use [onboarding](../SKILL.md). Host observations, chain profiles and local signer roles are separate evidence; none establishes the others or grants execution authorization.
