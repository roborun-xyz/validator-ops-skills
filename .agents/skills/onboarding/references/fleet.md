...
```bash
.venv/bin/python .agents/skills/sfdp-check/scripts/check_sfdp.py --fleet /path/to/fleet.json --validate-config
.venv/bin/python .agents/skills/sfdp-check/scripts/check_sfdp.py --fleet /path/to/fleet.json --api-only
```
