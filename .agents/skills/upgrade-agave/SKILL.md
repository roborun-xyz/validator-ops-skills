...
5. Install the verified binary with correct ownership and mode. Start with the recorded unstaked identity and original supervisor; verify the process actually uses the new executable.
